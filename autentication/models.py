...
class register(models.Model):
    ...
    gender= models.CharField(max_length=10, choices=type_choices, verbose_name="جنسیت")
    address=models.TextField(verbose_name='آدرس')
    postcode=models.CharField(verbose_name='کد پستی',null=True,blank=True)
    ...
    religen=models.CharField(verbose_name="دین",null=True,blank=True)
